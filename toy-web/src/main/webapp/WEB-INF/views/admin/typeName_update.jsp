...
<title>修改玩具类型 - 玩具类型管理 - H-ui.admin v3.0</title>
...
<article class="cl pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-admin-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-2 col-sm-2">类型名称:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  name="typeName" id="typeName" value="${maps['typeName']}">
            </div>
        </div>
        <div class="row cl">
