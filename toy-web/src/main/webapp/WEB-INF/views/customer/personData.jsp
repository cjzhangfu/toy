...
<body>
	...
	<div class="nav">
		<div class="nav_main w1200">
			<ul class="ovh">
				<li><a href="list.jsp">特卖专区</a></li><span>|</span>
				<li><a href="list.jsp">食品专区</a></li><span>|</span>
				<li><a href="list.jsp">日用专区</a></li><span>|</span>
				<li><a href="list.jsp">玩具专区</a></li><span>|</span>
				<li><a href="list.jsp">医疗专区</a></li><span>|</span>
				<li><a href="list.jsp">服饰专区</a></li><span>|</span>
	...
	<div class="cart">
		<div class="cart_main w1200 ovh">
			<div class="left fl">
				...
				<ul>
					<li><a href="cart.html">我的购物车<span>></span></a></li>
					<li><a href="user.html">已买到的商品<span>></span></a></li>
					<li><a class="on" href="data.html">完善个人资料<span>></span></a></li>
				</ul>
			</div>
			<div class="right fr">
				<h2>完善个人资料</h2>
				<form>
					<div class="form">
						<ul>
							...
							<li>
								<label>真实姓名：</label>
								<input id="name3" class="input" type="text"/>
							</li>
							<li>
								<label>性别：</label>
							...
							<li class="last">
								<label>上传头像：</label>
								<div id="imgdiv" class="imgdiv fl">
									<img id="imgShow" src="img/photo_bg.jpg" width="95" height="95" />
								</div>
								<div class="text fl">
									<div class="line">
										<input type="file" class="file" id="up_img" />
										<label for="up_img" class="file1">选择文件</label>
										<input name="" type="text" id="viewfile" class="inputstyle" />
									</div>
									<p>你可以上传GIF、PEG、JPG、PNG图片格式，<br/>尺寸为110＊110像素，文件大小限2k~600k</p>
								</div>
							</li>
