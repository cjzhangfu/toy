...
<!-- 产品详情图片放大展示 js -->
<script type="text/javascript" src="js/jquery.jqzoom2.js"></script>
		...
		<div class="show_main w1200">
			<div class="show_t ovh">
				<div class="show_t_img">
					...
					<div class="spec-scroll">
						  ...
						  <div class="items">
							<ul>
							  <li><img alt="" bimg="img/show_img1_b.jpg" src="img/show_img1_b.jpg" onmousemove="preview(this);"></li>
							  <li><img alt="" bimg="img/show_img2_b.jpg" src="img/show_img2_b.jpg" onmousemove="preview(this);"></li>
							  <li><img alt="" bimg="img/show_img1_b.jpg" src="img/show_img1_b.jpg" onmousemove="preview(this);"></li>
							  <li><img alt="" bimg="img/show_img2_b.jpg" src="img/show_img2_b.jpg" onmousemove="preview(this);"></li>
							  <li><img alt="" bimg="img/show_img1_b.jpg" src="img/show_img1_b.jpg" onmousemove="preview(this);"></li>
							  <li><img alt="" bimg="img/show_img2_b.jpg" src="img/show_img2_b.jpg" onmousemove="preview(this);"></li>
					...
					<!--缩图结束-->
					<div id="preview" class="spec-preview"> <span class="jqzoom"><img jqimg="img/show_img1_b.jpg" src="img/show_img1_b.jpg" /></span> </div>
				</div>
				<div class="text">
					<h2>韩国进口 SHOW CHAIN蛇链 P字链银色 半径2.0mm×长70cm</h2>
					<h3>市场价格：￥165.60</h3>
					<h3>价　　格：<span class="price">￥138.00</span><b>元</b></h3>
					<h3>销　　量：1500　　品牌：品牌名称文字代替</h3>
   					<h3 class="color_line"><div class="t fl">颜色：</div>
						<div class="color on" style="background:#009461;"></div>
						<div class="color" style="background:#06c180;"></div>
						<div class="color" style="background:#6c6c6c;"></div>
					</h3>
					<h3 class="size_line"><div class="t fl">尺码：</div>
						<div class="size">20cm</div>
						<div class="size on">20cm</div>
						<div class="size">20cm</div>
						<div class="size">20cm</div>
					</h3>
					<h3 class="stock_line">
					...
					<div class="button">
                        ...
                        <div class="add_cart"><img src="img/show_img1_b.jpg" width="25" height="25" alt="" /><a onClick="MoveBox(this)" href="javascript:;">加入购物车</a></div>
                    </div>
				</div>
			</div>
			<div class="show_b ovh">
				...
				<div class="right fr">
					<h2>产品详情</h2>
					<div class="con">
						<img src="img/show_con_img.jpg" alt=""/>
					</div>
				</div>
			</div>
		</div>
